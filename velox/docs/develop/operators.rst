...
.. list-table::
   ...
   * - insertTableHandle
     - Connector-specific description of the destination table. Its notNullColumns is a unique subset of columnNames that must not contain nulls; writing a null into one of them fails the query with a user error.
   * - outputType
